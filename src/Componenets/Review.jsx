...
<section className=" bg-[#F1F3F9]  py-14 font-poppins dark:bg-gray-800 ">
        <div className="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6 mt-10">
            <div className="max-w-xl mx-auto">
                <div className="text-center ">
                    <div className="relative flex flex-col items-center">
                        <h1 className="text-5xl font-bold dark:text-gray-200"> Customer <span className="text-red-500"> Reviews
                            </span> </h1>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
                <div className="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    <div
                        ...
                        <p className="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 12, SEP , 2022
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div className="flex px-6 mb-2 md:mb-0">
                                ...
                                <li>
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            className="w-4 mr-1 text-red-500 dark:text-red-400 bi bi-star-fill"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <h2 className="text-sm text-gray-500 dark:text-gray-400">Rating:<span
                            ...
                            <div className="flex items-center">
                                <div className="flex mr-3 text-sm text-gray-700 dark:text-gray-400">
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            className="w-4 h-4 mr-1 text-red-400 bi bi-hand-thumbs-up-fill"
                                            viewBox="0 0 16 16">
                                            <path
                                ...
                                <div className="flex text-sm text-gray-700 dark:text-gray-400">
                                    <a href="#" className="inline-flex hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" className="w-4 h-4 mr-1 text-red-400 bi bi-chat"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div
                        ...
                        <div className="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-300">
                                    William harry</h2>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Marketing Officer</p>
                            </div>
                        </div>
                        <p className="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 12, SEP , 2022
                        </p>
                    ...
                    <div
                        ...
                        <div className="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-300">
                                    James jack</h2>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Java Programmer</p>
                            </div>
                        </div>
                        <p className="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 12, SEP , 2022
                        </p>
