    ...
    <div className="justify-center flex-1 max-w-5xl px-4 py-4 mx-auto lg:py-10 md:px-7">
        <div className="max-w-xl mx-auto">
            <div className="text-center ">
                <div className="relative flex flex-col items-center">
                    ...
                    <h1 className="text-5xl font-bold dark:text-white"> Our <span className="text-red-500"> Contact
                        </span> </h1>
        ...
        <div className="flex flex-wrap mb-8 -mx-4">
            <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                <div
                    ...
                    <div
                        className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-red-500 rounded-full dark:bg-red-500">
                    ...
                    <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                        Email</h2>
                    <a href="#"
                        className="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">WebPageHandler@gmail.com</a>
                </div>
            </div>
            <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                <div
                    ...
                    <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                        Phone</h2>
                    <a href="#"
                        className="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">+212661255555</a>
                </div>
            </div>
            <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                <div
                    ...
                    <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                        Social</h2>
                    <a href="#"
                        className="inline-block mr-4 text-red-600 dark:text-red-400 dark:hover:text-red-300 hover:text-red-700">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a href="#"
                        className="inline-block mr-4 text-red-400 dark:text-red-400 dark:hover:text-red-300 hover:text-red-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a href="#"
                        className="inline-block mr-4 text-red-500 hover:text-red-600 dark:text-red-400 dark:hover:text-red-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div className="px-8 py-8 bg-white border rounded-md shadow-md dark:border-gray-800 dark:bg-gray-800">
            <form action="">
                ...
                <button
                    className="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-red-600 rounded-md dark:bg-red-500 dark:hover:bg-red-600 hover:bg-red-700">
                    Send Message
                </button>
            </form>
            </div>
