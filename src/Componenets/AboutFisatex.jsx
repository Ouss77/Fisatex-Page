        ...
        <section className="flex items-center bg-stone-100 xl:h-screen font-poppins dark:bg-gray-800">
            <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                        <h2 className="mb-4 text-4xl font-semibold text-red-500 dark:text-gray-300">
                            About Us
                        </h2>
                        ...
                        <a href="#" className="px-4 py-3 text-red-700 transition-all transform border border-red-500 rounded-3xl
                         hover:bg-red-600 dark:border-red-400 dark:hover:bg-red-500 dark:hover:text-gray-100 dark:hover:border-red-500 dark:text-red-400 hover:text-gray-100">
                            Contact Us
                        </a>
                    </div>
                </div>
